...
import de.throsenheim.unlimited.stockeasilyapi.service.config.IConfigService;
...
public class DatabaseConnectionFactory implements IDatabaseConnectionFactory {
    ...
    @Autowired
    public DatabaseConnectionFactory(Environment environment, IConfigService configService) {
    ...
    private static String getConnectionString(Environment environment, IConfigService configService) {
